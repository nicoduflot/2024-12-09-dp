...
class __TwigTemplate_d86676a6ff7fa1f76df12819c42e948b extends Template
{
  ...
  ";
        ...
        if (CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "footer", [], "any", false, false, true, 81)) {
            // line 82
            yield "    <footer role=\"contentinfo\" class=\"bg-dark text-white py-3\" data-bs-theme=\"dark\">
      ";
            // line 83
...
<div>
  ...
  {% if page.footer %}
    <footer role=\"contentinfo\" class=\"bg-dark text-white py-3\" data-bs-theme=\"dark\">
      {{ page.footer }}
    </footer>
  {% endif %}
